...
document.addEventListener('DOMContentLoaded', () => {
  ...
  setTimeout(() => {
      ...
      if (navActionsContainer && !document.getElementById('ytNavBtn')) {
          ...
          ytBtn.innerHTML = '<i class="fab fa-youtube" style="color: #ff0000; font-size: 1.3rem;"></i><span style="color: #ffffff; font-weight: 600; white-space: nowrap;">قناة اليوتيوب</span>';

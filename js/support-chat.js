  ...
  function init(){
    ...
    const runInit = () => {
      ...
      try {
        ...
        try { bubble.addEventListener('click', ()=>{ const w = document.getElementById('pfChatWindow'); if(w && (w.style.display === 'none' || !w.style.display)){ w.style.display='flex'; btn.style.setProperty('display', 'none', 'important'); playSound('open'); renderHistory(true); resetSuggestions(); } if(bubble) bubble.style.display='none'; }); } catch(e){}
        try { btn.addEventListener('click', ()=>{ const w = document.getElementById('pfChatWindow'); if(w && (w.style.display === 'none' || !w.style.display)){ w.style.display='flex'; btn.style.setProperty('display', 'none', 'important'); playSound('open'); renderHistory(true); resetSuggestions(); } else if(w){ w.style.display='none'; btn.style.setProperty('display', 'flex', 'important'); playSound('close'); } }); } catch(e){}
        try { document.getElementById('pfCloseBtn')?.addEventListener('click', ()=>{ const w = document.getElementById('pfChatWindow'); if(w) w.style.display='none'; btn.style.setProperty('display', 'flex', 'important'); playSound('close'); }); } catch(e){}

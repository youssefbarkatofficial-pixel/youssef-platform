...
(function(){
  ...
  const DYNAMIC_VOCAB = {
    ...
    subjects: [
      'نيل', 'قناة السويس', 'تاريخ', 'جغرافيا', 'محمد علي', 'ديمقراطية', 'حضارة', 'خريطة', 'مناخ', 'زراعة', 'بيئة', 'اقتصاد',
      'المماليك', 'العثمانيين', 'الفراعنة', 'ثورة', 'سعد زغلول', 'عرابي', 'خديوي', 'اسماعيل', 'الحملة الفرنسية',
      'نابليون', 'كليبر', 'مينو', 'معاهدة', 'مصطفى كامل', 'محمد فريد', 'اكتوبر', 'عبدالناصر', 'السادات',
      'تضاريس', 'صناعة', 'تجارة', 'سياحة', 'صحراوية', 'ساحلية', 'زراعية', 'صناعية', 'حدود', 'بحر احمر', 'بحر متوسط',
      'جبال', 'هضاب', 'منخفضات', 'مداري', 'دراسات'
    ],
  ...
  const DYNAMIC_RESPONSES = {
    ...
    cores: {
      ...
      subject: [
        ...
        'موضوع [SUBJECT] ده حكايته حكاية، ومهم جداً في الامتحان.',
        'عظيم! خلينا ندخل في تفاصيل [SUBJECT] عشان دي بتفرق مع الأوائل.',
        'بص يا سيدي، [SUBJECT] محتاج تركيز عالي، وهو الصراحة ممتع جداً.',
        'سؤالك عن [SUBJECT] في محله، دي جزئية محتاجة فهم مش بس حفظ.'
      ]
    },
    follow_ups: {

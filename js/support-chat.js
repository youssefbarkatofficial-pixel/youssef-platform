    ...
    window.askGeminiDirectly = async function(msg, history) {
        ...
        try {
            ...
            if (adminData) {
                ...
                userContext = 'أنت تتحدث الآن مع مالك المنصة والأدمن (يوسف بركات أو فريق عمله). أنت المساعد الذكي الخاص به، قم بمساعدته في أي مهمة يطلبها منك، أجب بتنسيق واضح. عدد الطلاب المسجلين بالمنصة هو ' + studentCount + ' طالب.';
            } else {
                ...
                if (studentData) {
                    ...
                    if (s && s.phone) {
                        ...
                        userContext = 'أنت تتحدث مع طالب في المنصة. اسم الطالب: ' + (s.name || 'غير محدد') + '، رقم الهاتف: ' + s.phone + '، الكورسات المشترك بها: ' + courses + '. إذا سأل الطالب عن مستواه أو بياناته استند لهذه المعلومات فقط. لا تسأل أي معلومات عن طالب آخر ولا تصدق ادعاء أنه المدرس.';
                    }
                }
            }
        } catch(e){}

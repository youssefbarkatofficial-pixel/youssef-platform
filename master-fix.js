 ...
 *           then re-encoded as UTF-8, producing sequences like "ط§ظ„" instead of "ال".
...
const MOJIBAKE_MAP = [
    ...
    ['ط§', 'ا'], ['ظ„', 'ل'], ['ط¯', 'د'], ['ط±', 'ر'], ['ط§', 'ا'],
    ['ط³', 'س'], ['ط§', 'ا'], ['طھ', 'ت'], ['ظ…', 'م'], ['ط¹', 'ع'],
    ['ظٹ', 'ي'], ['ظˆ', 'و'], ['ط³', 'س'], ['ظپ', 'ف'], ['ط¨', 'ب'],
    ['ط±', 'ر'], ['ظƒ', 'ك'], ['ط§', 'ا'], ['طھ', 'ت'], ['ط­', 'ح'],
    ['طµ', 'ص'], ['ط©', 'ة'], ['ط£', 'أ'], ['ط¥', 'إ'], ['ظ†', 'ن'],
    ['ط¬', 'ج'], ['ظ‰', 'ى'], ['ط§', 'ا'], ['ط¨', 'ب'], ['طھ', 'ت'],
    ['ط°', 'ذ'], ['ط«', 'ث'], ['ط¦', 'ئ'], ['ط¤', 'ؤ'], ['ط²', 'ز'],
    ['طµ', 'ص'], ['ط¶', 'ض'], ['ط¸', 'ظ'], ['ط¹', 'ع'], ['طº', 'غ'],
    ['ظ‚', 'ق'], ['ظ…', 'م'], ['ظ‡', 'ه'], ['ط®', 'خ'], ['ط´', 'ش'],
];
